...
<div class="panel" id="diretorios">
    ...
    <div id="slider">
        <ul class="navigation">
		    <li><a href="#1">Região Sul</a></li>
		    <li><a href="#2">Região Centro-Oeste</a></li>
		    <li><a href="#3">Região Sudeste</a></li>
            <li><a href="#4">Região Nordeste</a></li>
            <li><a href="#5">Região Norte</a></li>
        </ul>
