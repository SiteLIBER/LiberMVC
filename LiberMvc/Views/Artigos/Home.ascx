...
<div class="panel" id="artigos">
	...
	<div id="artigo_destaque" class="article_resume">
		...
		<p class="general_informations">
			<span class="date">
				<%= first.PublicadoEm.ToShortDateString()%></span> <span class="author">Por
					<%= Html.Label((!String.IsNullOrEmpty(first.Autor)) ? first.Autor : first.Editor.Nome)%>
		...
		<p class="general_informations">
			<span class="date">
				<%= art.PublicadoEm.ToShortDateString()%></span> <span class="author">Por
					<%= Html.Label((!String.IsNullOrEmpty(art.Autor)) ? art.Autor : art.Editor.Nome)%>
