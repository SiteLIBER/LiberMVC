  ...
  <span class="author"><%: Model.Editor.Nome %></span>
	...
	<span style="display: block; margin-top: 5px;">
		<span class="addthis_toolbox addthis_default_style" style="float: left;">
			<fb:like href="<%: Request.Url.OriginalString %>" show_faces="true" width="400" font="arial"></fb:like>
		</span>
		
		<!-- AddThis Button BEGIN -->
		<span class="addthis_toolbox addthis_default_style" style="float: right;"
      addthis:title="<%= Url.Encode(Model.Titulo) %>">
			<a href="http://www.addthis.com/bookmark.php?v=250&amp;pubid=xa-4d6c7b090593ecfb" class="addthis_button_compact"
			>Compartilhar</a>
