    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LiberMvc.Models.LiberDB>
    {
        ...
        protected override void Seed(LiberMvc.Models.LiberDB context)
        {
            ...
            //
					...
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Selecione o Grau de Instrução" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Ensino Fundamental (1ª a 8ª) [Incompleto]" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Ensino Fundamental (1ª a 8ª)" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Ensino Médio (Colegial) [Incompleto]" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Ensino Médio (Colegial)" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Ensino Médio (Magistério) [Incompleto]" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Ensino Médio (Magistério)" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Superior - Técnica [Incompleto]" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Superior - Técnica" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Superior - Graduação [Incompleto]" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Superior - Graduação" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Especialização e extensão [Incompleto]" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Especialização e extensão" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Pós-graduação [Incompleto]" });
					context.GrauInstrucao.AddOrUpdate(new GrauInstrucao { Descricao = "Pós-graduação" });
					...
					context.EstadoCivil.AddOrUpdate(new EstadoCivil { Descricao = "Viúvo (a)" });
					...
					context.Titulos.AddOrUpdate(new Titulo { TituloID = 1, Nome = "Usuário", Codigo = "Usuario" });
...
"
					...
					//context.Menus.AddOrUpdate(new Menu { MenuID = 3, Titulo = "História", Link = "Historia" });
					...
					//context.Menus.AddOrUpdate(new Menu { MenuID = 7, Titulo = "Lideranças Nacionais", Link = "Lideranca" });
					//context.Menus.AddOrUpdate(new Menu { MenuID = 8, Titulo = "Prestação de Contas", Link = "Contas" });
					...
					context.Autores.AddOrUpdate(new Autor { AutorID = 1, Nome = "André Luiz Santa Cruz Ramos" });
					...
					context.Autores.AddOrUpdate(new Autor { AutorID = 9, Nome = "Secretário Geral" });
